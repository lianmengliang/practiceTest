 ...
 * PACKAGE_NAME:com.xq.shop.common.pdd
 * AUTHOR: hexOr
 * DATE :2019/1/15 17:57
 * DESCRIPTION:网络请求工具类
 */
@Slf4j
public class OkHttpUtil {
    ...
    private static OkHttpClient getClient(long timeout) {
        return getClient(timeout, false);
    }

    private static OkHttpClient getClient(long timeout, boolean withCert) {
        OkHttpClient.Builder builder = new OkHttpClient.Builder()
                .connectTimeout(timeout, TimeUnit.MILLISECONDS);
        if (withCert) {
            //builder.sslSocketFactory(Objects.requireNonNull(WxSSLUtil.post()));
        }
    ...
    public static String requestOfGet(String url, Map<String, String> headers, String params) {
        url = url + params;
        ...
        try (Response response = call.execute()) {
            ...
            log.error("OkHttpUtil.requestOfGet请求:{}，异常：{}",url, e.getMessage());
        } catch (Exception ex) {
            log.error("OkHttpUtil.requestOfGet请求:{}，其他异常信息：{}",url, ex.getMessage());
        }
        return "";
    }
    ...
    public static String requestOfPost(String url, Object data) {
    ...
    public static String post(String url, String data, boolean withCert) {
        OkHttpClient okHttpClient = getClient(5000, withCert);
    ...
    public static String requestOfPostByObject(String url, Object data) {
        OkHttpClient okHttpClient = getClient(5000);
        MediaType mediaType = MediaType.parse("application/json;charset=utf-8");
