package com.example.test.java_basis.reflex.class_;

import com.example.test.java_basis.reflex.Car;
import com.example.test.java_basis.reflex.Cat;
...
public class ClassDemo {
    ...
    public static void class01() throws Exception {
        ...
        //2)反射方式
        Class aClass1 = Class.forName("com.example.test.java_basis.reflex.Cat");
        Class aClass2 = Class.forName("com.example.test.java_basis.reflex.Cat");
    ...
    public static void class02() throws Exception {
        ...
        String classFullPath = "com.example.test.java_basis.reflex.Car";
        // 获取到Car类，对应的Class对象
        // <?>标识不确定的Java类型
        Class<?> cls = Class.forName(classFullPath);
        // 输出cls  --class com.example.test.java_basis.reflex.Car
    ...
    public static void class05() throws Exception {
        ...
        Class<?> personClass = Class.forName("com.example.test.java_basis.reflex.Person");
    ...
    public static void class07() throws Exception {
        // 先获取类的Class对象
        Class<?> aClass = Class.forName("com.example.test.java_basis.reflex.Cat");
    ...
    public static void class08() throws Exception {
        ...
        Class<?> studentClass = Class.forName("com.example.test.java_basis.reflex.class_.Student");
...
//        name.set(o,"Leo");
    ...
    public static void class09() throws Exception {
        Class<?> cls = Class.forName("com.example.test.java_basis.reflex.class_.Student");
